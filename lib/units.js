  ...
  all(params = {}) {
    ...
    return Promise.all(requestInstances)
      .then((modules) => {
        ...
        modulesFiltered = modulesFiltered.filter((module, index, self) => self.findIndex(t => t.scolaryear === module.scolaryear && t.codemodule === module.codemodule && t.codeinstance === module.codeinstance && t.codeacti === module.codeacti) === index);
